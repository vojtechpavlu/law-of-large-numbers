...
const Controller = ({state, dispatch}) => {
  ...
  return (
    <div style={STYLE} className="m-3">
      ...
      <Button onClick={handleAutomaticRoll} variant="primary">Mass Roll <FontAwesomeIcon icon="fa-solid fa-rotate-right" spin /></Button>

      <Button onClick={handleSingleRoll} variant="success">Single Roll <FontAwesomeIcon icon="fa-solid fa-dice" shake /></Button>
